...
export default function Footer() {
  return (
    <footer>
          ...
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="flex flex-col  px-4 my-4 w-full xl:w-1/5">
              ...
              <p className="text-sm font-medium">
                Bare Botanics is a modern sanctuary for skin, rooted in the
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-lg pb-4 mb-4 border-b-2 border-blush-500">
                  Company
                </h2>
              </div>
      ...
      <div className="bg-blush-600 py-4 text-gray-900">
