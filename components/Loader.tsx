function Loader() {
  return (
    <div className="fixed inset-0 z-[9999] flex justify-center items-center bg-white min-h-[100vh]">
      {/* Spinning circle */}
      <div className="relative animate-spin rounded-full h-32 w-32 border-t-4 border-b-4 border-sage-400">
